...
KonqSidebar_MediaPlayer::KonqSidebar_MediaPlayer(const KComponentData &instance,QObject *parent,QWidget *widgetParent, QString &desktopName_, const char* name):
...
extern "C"
{
    KDE_EXPORT void* create_konqsidebar_mediaplayer(const KComponentData &instance,QObject *par,QWidget *widp,QString &desktopname,const char *name)
    {
	KGlobal::locale()->insertCatalog("konqsidebar_mediaplayer");
